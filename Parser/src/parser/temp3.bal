...
//                     io:println(<string>self.look.get("token"));
//                     self.matchToken("}");
...
//                     directives = self.directives();
//                 } else if (self.isLookahead("{")) {
//                     io:println("slection set line 350s");
//                     selSet.push(self.selectionSet());
//                     io:println(self.look.get("token"));
//                     self.matchToken("}");
//                     io:println("slection set line 350e");
//                 } else if (self.isLookahead("...")) {
//                     io:println("slection set line 356s");
//                     selSet.push(self.selectionSet());
//                     io:println(self.look.get("token"));
//                     io:println("slection set line 356e");
//                 }else {
//                     fields.push(name);
//                     break;
//                 }
